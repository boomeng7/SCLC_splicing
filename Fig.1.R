...
0000000000000 Fig.1b 000000000000000
0000000000000 Fig.1b 000000000000000
0000000000000 Fig.1b 000000000000000
...
SP_genes <- read.csv("/mnt/data/user_data/xiangyu/workshop/Zhong_ABao/Splicing/GO_term_summary_20250205_003645.csv")
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/TRMA_VS_TRM_Splicing_gene_volplot.pdf",height=4.5,width=4.5)
p1
dev.off()
scp /mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/TRMA_VS_TRM_Splicing_gene_volplot.pdf xiangmeng@172.16.1.21:/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/v1_Fig1/

0000000000000 Fig.1c 000000000000000
0000000000000 Fig.1c 000000000000000
0000000000000 Fig.1c 000000000000000

ASCL1_binding <- read.csv("/mnt/data/user_data/abao/1_project/Bulk_project/5_CUTTAG/ASCL1_SCLC_ICI/macs2_ASCL1_binding_promoter.csv")
ASCL1_binding <- ASCL1_binding %>% mutate(human_gene = convert_mouse_to_human_symbols(as.character(ASCL1_binding$SYMBOL))) %>% drop_na()

SP_genes <- read.csv("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing//GO_term_summary_20250205_003645.csv")
SP_genes_1 <- SP_genes %>% mutate(human_gene = convert_mouse_to_human_symbols(as.character(SP_genes$Symbol))) %>% drop_na()
...
p1 <- ggpie(aa, "Freq", label = "Var1",
      ...
      title = "ASCL1 binding")
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/ASCL1_binding_SFs_count_ggpie.pdf",height=3,width=3)
p1
dev.off()
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/v1_Fig1//ASCL1_binding_SFs_count_ggpie_add_percentage.pdf",height=3,width=3)
p1
dev.off()

0000000000000 Fig.1d 000000000000000
0000000000000 Fig.1d 000000000000000
0000000000000 Fig.1d 000000000000000
# 91:/mnt/data/user_data/xiangyu/workshop/Zhong_ABao/0_Endo_SCLC/0_ASCL1_CUTTag/GSE155692_Trudy_Oliver_ASCL1_CUTtag/GSM4710579_PB490_ASCL1_stringent.bw
91:/mnt/data/user_data/xiangyu/workshop/Zhong_ABao/0_Endo_SCLC/0_ASCL1_CUTTag/GSE155692_Trudy_Oliver_ASCL1_CUTtag/GSM4710579_PB490_ASCL1_stringent.bw
scp /mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/Fig1/ASCL1_biding_prmt5_igv_snapshot.svg xiangmeng@172.16.1.21:/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/v1_Fig1/
scp /mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/Fig1/ascl1_hnrnpa1_igv_snapshot.svg xiangmeng@172.16.1.21:/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/v1_Fig1/
scp /mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/Fig1/ascl1_srsf1_igv_snapshot.svg xiangmeng@172.16.1.21:/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/v1_Fig1/
scp /mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/Fig1/Hnrnph1_Ascl1_igv_snapshot.svg xiangmeng@172.16.1.21:/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/v1_Fig1/


0000000000000 Fig.1e 000000000000000
0000000000000 Fig.1e 000000000000000
0000000000000 Fig.1e 000000000000000
JHB_data_all1 <- read.csv(row.names=1,"/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/public_omics/JHB_cell_data_result1.csv")
library(BisqueRNA)
...
mcsaveRDS(JHB_SCLC_vs_Normal_res_GSEA,"/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/JHB_SCLC_hsa.GeneList_GSEA.rds",mc.cores=20)
JHB_SCLC_vs_Normal_res_GSEA <- mcreadRDS("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/JHB_SCLC_hsa.GeneList_GSEA.rds",mc.cores=20)
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/JHB_RNA_GSVA_splicing_SCLC_VS_normal.pdf",height=3.5,width=7)
p1
dev.off()


GSE60052_data_all1 <- read.csv(row.names=1,file="/mnt/data/user_data/xuelan/project/1naifeifei/humandata_lung/sclc_human_lung/resSCLC.csv")
...
mcsaveRDS(GSE60052_SCLC_vs_Normal_res_GSEA,"/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/GSE60052_SCLC_hsa.GeneList_GSEA.rds",mc.cores=20)
GSE60052_SCLC_vs_Normal_res_GSEA <- mcreadRDS("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/GSE60052_SCLC_hsa.GeneList_GSEA.rds",mc.cores=20)
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/PLOS_GENE_GSVA_splicing_SCLC_VS_normal.pdf",height=3.5,width=8)
p1
dev.off()

zgb_data_dds_res <- read.csv("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/public_omics/ZGB_SCLC_DATA/2_output/ZGB_SCLC_DATA_result.csv",row.names=1)
...
mcsaveRDS(zgb_SCLC_vs_Normal_res_GSEA,"/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/zgb_SCLC_hsa.GeneList_GSEA.rds",mc.cores=20)
zgb_SCLC_vs_Normal_res_GSEA <- mcreadRDS("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/zgb_SCLC_hsa.GeneList_GSEA.rds",mc.cores=20)
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/zgb_GSVA_splicing_SCLC_VS_normal.pdf",height=3.5,width=8)
p1
dev.off()


Cell2024_Zhangpeng2 <- read.csv(row.names=1,"/mnt/data/user_data/xiangmeng/database/SCLC_Patient_data/2024_Zhangpeng_SCLC_proteomics/Cell_ZhangPeng_Protein_Matrix.csv")
Cell_Zhangpeng_clinical <- read.csv(row.names=1,"/mnt/data/user_data/xiangmeng/database/SCLC_Patient_data/2024_Zhangpeng_SCLC_proteomics/Zhangpeng_SCLC_and_Normal_Clinical.csv")
...
mcsaveRDS(res_1,"/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/JHB_Protein_SCLC_TvsN_res.rds",mc.cores=20)
JHB_protein_res <- mcreadRDS("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/JHB_Protein_SCLC_TvsN_res.rds",mc.cores=20)
...
mcsaveRDS(JHB_protein_SCLC_vs_Normal_res_GSEA,"/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/JHB_Protein_SCLC_GSVA.rds",mc.cores=20)

JHB_protein_SCLC_vs_Normal_res_GSEA <- mcreadRDS("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/JHB_Protein_SCLC_GSVA.rds",mc.cores=20)
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/JHB_protien_GSVA_splicing_SCLC_VS_normal.pdf",height=3.5,width=8)
p1
dev.off()


0000000000000 Fig.1f 000000000000000
0000000000000 Fig.1f 000000000000000
0000000000000 Fig.1f 000000000000000
SCLC_sce_Lung_obj <- mcreadRDS("/mnt/data/user_data/yucui/Project/Other_Work/1-SCLC-Splicing/SCLC_sce_Lung_obj.rds",mc.cores=20)
SCLC_sce_Lung_obj <- readRDS("/mnt/data/user_data/yucui/Project/Other_Work/1-SCLC-Splicing/SCLC_sce_Lung_obj.rds")
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/MSK_patients_scRNAseq_umap.pdf",height=4,width=6.6)
p2
dev.off()


0000000000000 Fig.1g 000000000000000
0000000000000 Fig.1g 000000000000000
0000000000000 Fig.1g 000000000000000
SP_genes <- read.csv("/mnt/data/user_data/xiangyu/workshop/Zhong_ABao/Splicing/GO_term_summary_20250205_003645.csv")
SP_genes_1 <- SP_genes %>% mutate(human_gene = convert_mouse_to_human_symbols(as.character(SP_genes$Symbol))) %>% drop_na()
...
p1
dev.off()
ggsave("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/MSK_patients_scRNAseq_SFs_featureplot_umap_v31.png", plot=p1,width = 4, height = 3.5,dpi=1080)
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/scRNAseq_MSK_subtype_SFs_expression_all_sub.pdf",height=3,width=5)
p1
dev.off()


0000000000000 Fig.1i 000000000000000
0000000000000 Fig.1i 000000000000000
0000000000000 Fig.1i 000000000000000
IMPOWER133_Clinical <- read.csv("/mnt/data/user_data/xiangmeng/database/SCLC_Patient_data/2021_ICI_trail_IMpower133//IMPOWER133_Clinical_file.csv")
...
IMPOWER133_SCLC_bulkRNA2 <- read.csv(row.names="UNNAMED..0","/mnt/data/user_data/xiangmeng/database/SCLC_Patient_data/2021_ICI_trail_IMpower133/IMPOWER133_SCLC_TPM_file.csv")
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/IMPOWER133_subtype_SFs_expression_v3.pdf",height=3,width=3)
p1
dev.off()
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/JHB_RBA_subtype_SFs_expression_v2.pdf",height=3,width=3)
p1
dev.off()

PLOS_GENE_count <- read.csv(row.names=1,file="/mnt/data/user_data/xuelan/project/1naifeifei/humandata_lung/sclc_human_lung/GSE60052_79tumor.7normal.normalized.log2.data.Rda.tsv",sep = "\t")
...
p1 <- ggplot(PLOS_GENE_count2, aes(x = subtype, y = log2(SFs), color = subtype, fill = subtype)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10, color = "black"),
        axis.text.y = element_text(size = 10, color = "black")) +
  stat_compare_means(comparisons = list(c("BaseLine", "Resis_Ctrl")), label = "p.signif", method = "t.test")
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/PLOS_GENE_subtype_SFs_expression_v2.pdf",height=3,width=3)
p1
dev.off()
...
p1 <- ggplot(zgb_data_dds_count1, aes(x = subtype1, y = log2(SFs), color = subtype1, fill = subtype1)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10, color = "black"),
        axis.text.y = element_text(size = 10, color = "black")) +
  stat_compare_means(comparisons = list(c("NE", "Non-NE")), label = "p.signif", method = "t.test")
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/ZGB_subtype_SFs_expression_v3.pdf",height=3,width=3)
p1
dev.off()
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/ZGB_subtype_SFs_expression_log_NE_and_Non-NE.pdf",height=3,width=3)
p1
dev.off()

00000000000000000 JHB Protien 0000000000000000000000
00000000000000000 JHB Protien 0000000000000000000000
00000000000000000 JHB Protien 0000000000000000000000

Cell2024_Zhangpeng2 <- read.csv(row.names=1,"/mnt/data/user_data/xiangmeng/database/SCLC_Patient_data/2024_Zhangpeng_SCLC_proteomics/protein_expression_matrix.csv")
...
p1 <- ggplot(Cell2024_Zhangpeng3, aes(x = subtype, y = log2(SFs), color = subtype, fill = subtype)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10, color = "black"),
        axis.text.y = element_text(size = 10, color = "black")) +
  stat_compare_means(comparisons = list(c("BaseLine", "Resis_Ctrl")), label = "p.signif", method = "t.test")
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/JHB_protein_subtype_SFs_expression_v2.pdf",height=3,width=3)
p1
dev.off()


0000000000000 Fig.1j 000000000000000
0000000000000 Fig.1j 000000000000000
0000000000000 Fig.1j 000000000000000

00000000000000000 Nature data for survival 00000000000000000
00000000000000000 Nature data for survival 00000000000000000
00000000000000000 Nature data for survival 00000000000000000

SCLC_patients_RNA <- read.csv("/mnt/data/user_data/xiangyu/workshop/DATABASE/SCLC_Patient_data/SCLC_Nature_RNA.csv")
SCLC_patients_clinical <- fread("/mnt/data/user_data/xiangyu/workshop/DATABASE/SCLC_Patient_data/SCLC_Nature_Clinical.csv")
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/Nature2013_SFs_OS_survival.pdf",height=5,width=4)
p1
dev.off()


0000000000000 CTC CDX 0000000000000
0000000000000 CTC CDX 0000000000000
0000000000000 CTC CDX 0000000000000
CTC_data <- mcreadRDS("/mnt/data/user_data/xiangyu/workshop/DATABASE/SCLC_Patient_data/SCLC_CTC/bulk_RNA/counts_table/SCLC_CTC.bulk.all.data.rds",mc.cores=20)
CTC_meta_data <- mcreadRDS("/mnt/data/user_data/xiangyu/workshop/DATABASE/SCLC_Patient_data/SCLC_CTC/bulk_RNA/counts_table/SCLC_CTC.bulk.meta.rds",mc.cores=20)

setwd("/mnt/data/user_data/xiangyu/workshop/DATABASE/")
...
write.csv(all_tmp1,"/mnt/data/user_data/xiangmeng/project/3_WYY_SCLC_brain_metastasis_rnaseq/public_data/CTC_CDX/all_tmp1_clinical.csv")
all_tmp1 <- read.csv(row.names=1,"/mnt/data/user_data/xiangmeng/project/3_WYY_SCLC_brain_metastasis_rnaseq/public_data/CTC_CDX/all_tmp1_clinical.csv")

CDX_res1 <- read.csv("/mnt/data/user_data/xiangmeng/project/3_WYY_SCLC_brain_metastasis_rnaseq/CTC_CDX_cohots_CDX14P_Brian_vs_OTS_v2.csv",row.names=1,header=TRUE)
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/CTC_CDX_SFs_survival.pdf",height=5,width=4)
p1
dev.off()


00000000000 JHB_data_all1 000000000000
00000000000 JHB_data_all1 000000000000
00000000000 JHB_data_all1 000000000000
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/JHB_RNA_SFs_OS_survival.pdf",height=5,width=4)
p1
dev.off()



0000000000000 protein 0000000000000
0000000000000 protein 0000000000000
0000000000000 protein 0000000000000
...
# scp -r /mnt/data/user_data/xiangyu/workshop/Zhong_ABao/0_Endo_SCLC/Reference_Data/human_SCLC/Cell_ZhangPeng/Abao_Transfromed_matrix/* xiangmeng@172.16.1.21:/mnt/data/user_data/xiangmeng/database/SCLC_Patient_data/2024_Zhangpeng_SCLC_proteomics/
SP_genes <- read.csv("/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/GO_term_summary_20250205_003645.csv")
SP_genes_1 <- SP_genes %>% mutate(human_gene = convert_mouse_to_human_symbols(as.character(SP_genes$Symbol))) %>% drop_na()
...
pdf(file="/mnt/data/user_data/xiangmeng/project/tmp/OTS/2_SCLC_splicing/output/Fig1/CellZhangpeng_protein_SFs_survival.pdf",height=5,width=4)
p1
dev.off()